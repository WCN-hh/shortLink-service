...
import static com.hhfindjob.shortlink.project.common.constant.RedisKeyConstant.DELAY_QUEUE_STATS_KEY;
                        ...
                        try {
                            ...
                            if (statsRecord != null) {
                                if (!messageQueueIdempotentHandler.isMessageProcessed(statsRecord.getKeys())){
                                    // 判断当前这个消息流程是否执行完毕
                                    if (messageQueueIdempotentHandler.isCompleted(statsRecord.getKeys())){
                                        return;
                                    }
                                ...
                                messageQueueIdempotentHandler.setComplete(statsRecord.getKeys());
                                continue;
                            }
