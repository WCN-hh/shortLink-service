...
import com.hhfindjob.shortlink.project.dao.entity.statsDOSet.LinkBrowserStatsDO;
...
public interface LinkBrowserStatsMapper extends BaseMapper<LinkBrowserStatsDO> {
    ...
    @Insert("INSERT INTO t_link_browser_stats " +
            ...
            "VALUES" +
            "(#{DO.fullShortUrl}, #{DO.gid}, #{DO.date}, #{DO.cnt}, #{DO.browser}, NOW(), NOW(), 0) " +
            "ON DUPLICATE KEY UPDATE cnt = cnt + #{DO.cnt};")
    void insertBrowserStats(@Param("DO") LinkBrowserStatsDO DO);
