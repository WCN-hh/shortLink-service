...
public interface LinkAccessLogsMapper extends BaseMapper<LinkAccessLogsDO> {
    ...
    @Select("SELECT " +
            ...
            "WHERE gid = #{dto.gid} " +
            "  AND full_short_url = #{dto.fullShortUrl} " +
            "  AND create_time BETWEEN #{dto.startDate} AND #{dto.endDate} " +
            "GROUP BY " +
            "    full_short_url,gid;")
    LinkAccessStatsDO countPvUvUip(@Param("dto") ShortLinkStatsReqDTO dto);
