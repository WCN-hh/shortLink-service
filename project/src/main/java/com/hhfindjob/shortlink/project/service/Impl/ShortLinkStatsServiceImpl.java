...
import com.hhfindjob.shortlink.project.dto.resp.statsRespDTO.*;
import com.hhfindjob.shortlink.project.service.ShortLinkStatsService;
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    @Override
    public IPage<ShortLinkStatsAccessRecordRespDTO> pageSelectAccessRecord(ShortLinkStatsAccessRecordReqDTO dto) {

        LambdaQueryWrapper<LinkAccessLogsDO> wrapper = Wrappers.lambdaQuery(LinkAccessLogsDO.class)
                .eq(LinkAccessLogsDO::getFullShortUrl, dto.getFullShortUrl())
                .eq(LinkAccessLogsDO::getGid, dto.getGid())
                .eq(LinkAccessLogsDO::getDelFlag,0)
                .between(LinkAccessLogsDO::getCreateTime, dto.getStartDate(), dto.getEndDate());

        IPage<LinkAccessLogsDO> resultPage = linkAccessLogsMapper.selectPage(dto, wrapper);

        List<String> userList = resultPage.getRecords()
                .stream()
        ...
        IPage<ShortLinkStatsAccessRecordRespDTO> convert = resultPage.convert(
                e -> BeanUtil.toBean(e, ShortLinkStatsAccessRecordRespDTO.class)
        );
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        LinkAccessStatsDO linkAccessStatsDO = linkAccessLogsMapper.countPvUvUip(requestParam);
        // 地区访问详情（仅国内）
    ...
    @Override
    public IPage<ShortLinkStatsAccessRecordRespDTO> groupPageStatsAccessRecord(ShortLinkGroupStatsAccessRecordReqDTO dto) {
        LambdaQueryWrapper<LinkAccessLogsDO> wrapper = Wrappers.lambdaQuery(LinkAccessLogsDO.class)
                .eq(LinkAccessLogsDO::getGid, dto.getGid())
                .eq(LinkAccessLogsDO::getDelFlag,0)
                .between(LinkAccessLogsDO::getCreateTime, dto.getStartDate(), dto.getEndDate());
